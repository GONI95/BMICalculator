...
internal class MonthCategoryFragment :
    ...
    override val viewModel: MonthCategoryViewModel by viewModel { parametersOf(todoCategory) }
    ...
    companion object {
        ...
        fun newInstance(monthCategory: MonthCategory) = MonthCategoryFragment().apply {
            arguments = bundleOf(
