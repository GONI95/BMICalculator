...
object Constants {
    ...
    /**
     * Gon [22.05.11] : FragmentManager에 해당 상수를 TAG로 BottomSheetDialogFragment를 추가하여 표시하기 위해 사용되는 상수 정의
     */
    const val DIALOG_FRAGMENT_TAG: String = "MEAL_NTR_IRDNT_DIALOG_FRAGMENT"
