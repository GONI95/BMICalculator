...
/**
 * Gon [22.02.26] : ViewHolder, RecyclerViewAdapter는 리스트를 표시하는 작업을 하고 Data의 상태를 제어하지 않고
 ...
 *                  Button 클릭 시 호출하기 위한 추상 메서드 onClickCountUpdateButton() 선언
 */
interface CalculatorListener : AdapterListener {
    fun onClickRemoveButton(model: FoodNtrIrdntModel)
    fun onClickCountUpdateButton(servingCount: Int, position: Int)
}
